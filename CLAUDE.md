...
4. The `.github/workflows/release.yml` workflow will automatically build `cbs-statline-skill.zip` and attach it to the GitHub Release

The zip is then available at:
`https://github.com/linksmith/cbs-statline-skill/releases/latest/download/cbs-statline-skill.zip`

## Project structure

- `.claude-plugin/plugin.json` — Plugin manifest for Claude/Open/Kilo Code
- `skills/cbs-statline-skill/SKILL.md` — Skill definition (plugin layout)
